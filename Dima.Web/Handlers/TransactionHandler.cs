...
public class TransactionHandler(IHttpClientFactory httpClientFactory) : ITransactionHandler
{
    ...
    public async Task<Response<Transaction?>> CreateAsync(CreateTransactionRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Transaction?>>()
               ?? new Response<Transaction?>(null, (int)result.StatusCode, "Não foi possível criar a transação");
    }
    ...
    public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Transaction?>>()
               ?? new Response<Transaction?>(null, (int)result.StatusCode, "Não foi possível atualizar a transação");
    }
    ...
    public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
    {
        ...
        return await result.Content.ReadFromJsonAsync<Response<Transaction?>>()
               ?? new Response<Transaction?>(null, (int)result.StatusCode, "Não foi possível deletar a transação");    }
